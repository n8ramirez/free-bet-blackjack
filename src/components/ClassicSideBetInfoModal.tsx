import { LUCKY_LADIES_PAYOUTS } from '../hooks/useClassicGameState'
import { LuckyLadiesIcon } from './ClassicSideBetPanel'
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tab bar — Lucky Ladies only for now */}
        <div className="flex border-b border-stone-700">
          <div className="flex-1 py-2.5 text-center text-[10px] uppercase tracking-widest font-extrabold
        ...
        <div className="flex flex-col gap-4 text-sm p-5">
          <div className="flex items-center gap-2">
            <LuckyLadiesIcon className="w-8 h-8 flex-shrink-0" />
          ...
          <Section title="Payout table">
            <div className="mt-1 rounded-xl overflow-hidden border border-stone-700">
              ...
              {LUCKY_LADIES_PAYOUTS.map(([name, mult], i) => (
              ...
              <div className={`grid grid-cols-2 px-3 py-2 ${LUCKY_LADIES_PAYOUTS.length % 2 === 0 ? 'bg-stone-900' : 'bg-stone-800/50'}`}>
