...
export function Card({ card, faceDown = false, dimmed = false, glowing = false, push22Glow = false, luckyLadiesGlow = false }: CardProps) {
  ...
  if (luckyLadiesGlow) return <div className="lucky-ladies-glow inline-block">{cardEl}</div>
