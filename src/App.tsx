...
export default function App() {
  ...
  return (
    <div className="h-[100dvh] bg-felt flex flex-col overflow-hidden">
      ...
      <div className={`flex-none flex flex-col items-center w-full ${isQuadrant ? '-mt-[200px] pb-[12px]' : ''}`}>
        {isOver ? (
      ...
      {/* ── Player area ─────────────────────────────────────────── */}
      <div className={`flex-1 flex flex-col items-center min-h-0 w-full ${isQuadrant ? 'justify-start pt-0' : 'justify-center py-4'}`}>
        {debugSplit ? (
